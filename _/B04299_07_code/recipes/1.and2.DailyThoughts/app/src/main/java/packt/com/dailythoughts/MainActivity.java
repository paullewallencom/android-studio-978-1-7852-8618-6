...
import packt.com.dailythoughts.fragments.ThoughtsDetailFragment;
import packt.com.dailythoughts.fragments.ThoughtsFragment;
import packt.com.dailythoughts.fragments.ThoughtsKpiFragment;

public class MainActivity extends Activity
        implements NavigationDrawerFragment.NavigationDrawerCallbacks, ThoughtsDetailFragment.DetailFragmentListener {
    ...
    private ThoughtsDetailFragment getThoughtDetailFragment(){
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        if (position==1) {
            ...
            fragmentManager.beginTransaction()
                    .replace(R.id.container, getThoughtsFragment())
                    .commit();
        }
        else  if (position==0){
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            case 0:
                mTitle = getString(R.string.title_section_daily_notes);
                break;
            case 1:
                mTitle = getString(R.string.title_section_note_list);
                break;
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id== R.id.action_add)
        {
            FragmentManager fragmentManager = getFragmentManager();
            fragmentManager.beginTransaction()
                    .add(R.id.container, getThoughtDetailFragment())
                    .commit();
        }
    ...
    @Override
    public void onSave() {
        getFragmentManager().beginTransaction().remove(mThoughtsDetailFragment).commit();
    }
