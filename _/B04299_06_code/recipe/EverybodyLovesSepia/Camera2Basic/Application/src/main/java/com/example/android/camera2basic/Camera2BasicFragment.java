...
public class Camera2BasicFragment extends Fragment implements View.OnClickListener {
    ...
    private void makeItSepia(){
        //
        ColorMatrix cm1 = new ColorMatrix();
        cm1.setSaturation(0);
        ColorMatrix cm2 = new ColorMatrix();
        cm2.setScale(1f, .95f, .82f, 1.0f);
        cm1.setConcat(cm2,cm1);
        final ColorMatrixColorFilter cmf = new ColorMatrixColorFilter(cm1);

        if (mTextureView != null && mTextureView.getBackground() != null){
            mTextureView.getBackground().setColorFilter(cmf);
        }
    }
    /**
